...
class Barangmasuk extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = "Barang Masuk";
            $data['supplier'] = $this->admin->get('pb_supplier');
            $data['barang'] = $this->admin->get('pb_barang');

            // Mendapatkan dan men-generate kode transaksi barang masuk
            $kode = 'BM-' . date('ymd');
            $kode_terakhir = $this->admin->getMax('pb_barang_masuk', 'id_barang_masuk', $kode);
            ...
            $insert = $this->admin->insert('pb_barang_masuk', $input);
    ...
    public function delete($getId)
    {
        ...
        if ($this->admin->delete('pb_barang_masuk', 'id_barang_masuk', $id)) {
