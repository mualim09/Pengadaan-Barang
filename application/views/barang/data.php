                ...
                if ($barang) :
                    foreach ($barang as $b) :
                        ...
                        <tr>
                            ...
                            <td><?= $b['stok']; ?></td>
                            <td><?= $b['nama_satuan']; ?></td>
							<td><a href="<?php echo base_url();?>assets/qr/<?= $b['id_barang']; ?>.png" target="_blank"><img style="width: 50px; height: 50px;" src="<?php echo base_url();?>assets/qr/<?= $b['id_barang']; ?>.png"></img></a></td>
                            <td>
